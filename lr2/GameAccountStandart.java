public class GameAccountStandart extends GameAccountBasic {
    public GameAccountStandart(String userName, double currentRating) {
        super(userName, currentRating);
        UserName = userName;
        CurrentRating = currentRating;
    }

    public void WinGame(BasicClass game, GameAccountStandart opponentplayer) throws Exception {
    ...
    public void LoseGame(BasicClass game, GameAccountStandart opponentplayer) throws Exception {
